<script setup>
// No props or data needed for this component since it's static
</script>

<template>
  <div class="mt-8">
    <div class="p-6 rounded-md shadow-md border border-amber-200 bg-gradient-to-r from-amber-50 via-yellow-50 to-orange-50">
